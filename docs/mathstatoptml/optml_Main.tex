...
%\includeonly{chp-rl}
%\includeonly{chp-cvx-opt}
%\includeonly{chp-ml-basics}
%\includeonly{chp-cvx-analysis}
%\includeonly{chp-stat-basics}
%\includeonly{chp-linalg}
%\includeonly{chp-app-opt}
...
\include{chp-stat-basics}

\chapter{Bayesian Statistics}
\include{chp-bayes-stat}

\chapter{Information Theory}
\include{chp-info-theory}
